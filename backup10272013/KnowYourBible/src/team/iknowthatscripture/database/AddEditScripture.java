...
import team.iknowthatscripture.R;
import team.iknowthatscripture.R.id;
import team.iknowthatscripture.R.layout;
import team.iknowthatscripture.R.string;
...
public class AddEditScripture extends Activity {
	...
	OnClickListener saveScriptureButtonClicked = new OnClickListener(){
		...
		public void onClick(View v){
			if(passage.getText().length() == 0){
				AlertDialog.Builder vpassage = new AlertDialog.Builder(AddEditScripture.this);
				...
				AlertDialog.Builder vbook = new AlertDialog.Builder(AddEditScripture.this);
				...
				AlertDialog.Builder vchapter = new AlertDialog.Builder(AddEditScripture.this);
				...
				AlertDialog.Builder vverse = new AlertDialog.Builder(AddEditScripture.this);
