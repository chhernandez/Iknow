	...
	OnClickListener saveScriptureButtonClicked = new OnClickListener(){
		...
		public void onClick(View v){
			if(passage.getText().length() == 0){
				...
				AlertDialog.Builder vbook = new AlertDialog.Builder(AddScripture.this);
				...
				AlertDialog.Builder vchapter = new AlertDialog.Builder(AddScripture.this);
				...
				AlertDialog.Builder vverse = new AlertDialog.Builder(AddScripture.this);
