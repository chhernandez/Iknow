...
public class DatabaseConnector {
	   ...
	   public void updateRating(long id, String passage, String book, int chapter, 
	      int verse) {
	   ...
	   public Cursor getAllScriptures() {
		      return database.query("scriptures", new String[] {"_id", "passage"}, 
		         null, null, null, null, "passage");
		      // query(String table, 
